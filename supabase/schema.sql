-- ==============================================================================
-- DELIGHTPREP DATABASE SCHEMA FOR SUPABASE POSTGRESQL
-- Production-ready, RLS-enabled, normalized schema for Nigerian Exam Preparation Platform
-- Covers: auth users integration, profiles, schools, curriculum, subjects, topics,
--         student onboarding profiles, question provenance, CBT exam sessions,
--         diagnostic results, gamification, and subscriptions.
-- ==============================================================================
...
-- 3. PROFILES (Integrated with auth.users)
...
-- 8. STUDENT PROFILES (Onboarding results & study tracking)
...
-- 13. AUTH TRIGGER (Auto create profile when user registers via Supabase Auth)
